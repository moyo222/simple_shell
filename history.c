...
/**
* write_history - This is a function that creates a file,
...
/**
* read_history - This function reads the history from the file
* @info: This is the parameter struct
*
...
/**
* build_history_list - This is a function that adds
* entries to a history linked list
...
/**
* renumber_history - This is the function that renumbers the
